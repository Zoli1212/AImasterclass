...
video_file = cv2.VideoCapture(os.path.abspath("./videos/cod_trailer_1.mp4"))
...
image_alex_1 = face_recognition.load_image_file(os.path.abspath("./images/alex1.png"))
image_badguy_1 = face_recognition.load_image_file(os.path.abspath("./images/badguy1.png"))
image_farah_1 = face_recognition.load_image_file(os.path.abspath("./images/farah1.png"))
image_laswell_1 = face_recognition.load_image_file(os.path.abspath("./images/laswell1.png"))
image_price_1 = face_recognition.load_image_file(os.path.abspath("./images/price1.png"))
